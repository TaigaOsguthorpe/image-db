...
from ui import about, v1_tag_maker, image_viewer
import imghdr
import sys
import os
#import atexit
...
class Ui_MainWindow(object):
    ...
    def open_file(self):
        ...
        self._ui = image_viewer.Ui_ImageVeiwer()
        self._ui.setupUi(ImageVeiwer=self._ImageViewer, file=path)
        self.i._exec()
...
#        self._ui.setupUi(TagMakerDialog=self._tag_c, db=self.db, assign=True, info=info)
    ...
    def retranslateUi(self, MainWindow):
        # Learn how translation in QT works.
